...
class AudioSwitch internal constructor(
     ...
     * [AudioDevice.BluetoothHeadset], [AudioDevice.WiredHeadset], [AudioDevice.Earpiece], [AudioDevice.Speaker].
     */
    ...
    private fun activate(audioDevice: AudioDevice) {
        ...
        when (audioDevice) {
            ...
            is AudioDevice.Speaker -> audioManager.enableSpeakerphone(true)
        }
    }
        ...
        preferredDeviceList.forEach { audioDevice ->
            ...
            when (audioDevice) {
                ...
                AudioDevice.Speaker::class.java -> {
                    ...
                    if (hasSpeakerphone) {
                        mutableAudioDevices.add(AudioDevice.Speaker())
                    }
                }
            }
        }
