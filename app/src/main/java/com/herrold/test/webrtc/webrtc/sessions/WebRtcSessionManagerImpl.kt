...
import com.herrold.test.webrtc.webrtc.SignalingCommand
import com.herrold.test.webrtc.webrtc.audio.AudioHandler
import com.herrold.test.webrtc.webrtc.audio.AudioSwitchHandler
import com.herrold.test.webrtc.webrtc.peer.StreamPeerConnection
import com.herrold.test.webrtc.webrtc.peer.StreamPeerConnectionFactory
import com.herrold.test.webrtc.webrtc.peer.StreamPeerType
import com.herrold.test.webrtc.webrtc.utils.stringify
...
class WebRtcSessionManagerImpl(
    ...
    private val surfaceTextureHelper = SurfaceTextureHelper.create(
        ...
        peerConnectionFactory.baseContext
    )
